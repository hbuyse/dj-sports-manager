...
from .helper import create_user, create_team
...
class TestTeamDetailViewAsAnonymous(TestCase):
    ...
    def test_get_not_existing(self):
        """Tests."""
        r = self.client.get(reverse('dj-sports-manager:team-detail', kwargs={'slug': 'toto'}))

        self.assertEqual(r.status_code, 404)

    def test_get(self):
        """Tests."""
        r = self.client.get(reverse('dj-sports-manager:team-detail', kwargs={'slug': self.team.slug}))
