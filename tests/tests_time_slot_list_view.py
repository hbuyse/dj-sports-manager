...
from .helper import create_team, create_time_slot, create_user
...
class TestTimeSlotListViewAsAnonymous(TestCase):
    ...
    def tests_empty(self):
        """Tests."""
        r = self.client.get(reverse('dj-sports-manager:team-time-slots-list', kwargs={'slug': self.team.slug}))
