...
from .helper import create_user, create_category
...
class TestTeamCreateViewAsAnonymous(TestCase):
    ...
    def test_get(self):
        """Tests."""
        r = self.client.get(reverse('dj-sports-manager:team-create'))
    ...
    def test_post(self):
        ...
        r = self.client.post(reverse('dj-sports-manager:team-create'), d)
