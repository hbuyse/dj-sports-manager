...
from sports_manager.models.player import EmergencyContact, MedicalCertificate, Player, medical_certificate_upload_to, identity_card_upload_to, identity_photo_upload_to
